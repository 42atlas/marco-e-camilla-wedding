...
import buttone from '../public/images/bottone-desktop.png'
    ...
    <main className='' id='doc'>
      ...
      <section className='h-screen w-full' id='section_4'>
        <div className='w-full h-full flex flex-col items-center '>
          <h3 className='text-5xl font-bold text-[#ADA08F] font-[Tangerine] p-8 md:mt-10'>
            {t('itinerario')}
          </h3>
            ...
            <table className=' self-center'>
              <tbody>
                ...
                <tr>
                  ...
                  <td className='p-4 pt-10 flex flex-col items-start'>
                    <a
      ...
      <section className='h-screen w-full ' id='section_5'>
        ...
        <div className='w-full flex flex-col justify-center items-center py-3 z-10'>
          <h3 className='text-2xl md:text-4xl font-[Lato] font-light text-center p-5 text-[#ADA08F] z-10'>
            San Casciano Val Di Pesa
          </h3>
          <p className='text-[Lato] text-xs md:text-sm text-[#2B1105] p-4 md:px-20 text-center z-10'>
            {t('villa')}
          </p>
          <p className='text-[Lato] font-sm md:font-md text-[#2B1105] font-bold z-10'>
            {t('asp')}
          </p>
        </div>
      </section>
      <section className='h-screen w-full' id='section_6'>
        <div className='w-full h-full flex flex-col justify-start items-center'>
          <h1 className='text-7xl md:text-9xl font-bold text-center text-[#6D8776] font-[Tangerine] mt-5'>
            {t('partecipazione')}
          </h1>
          <div className='w-full lg:max-w-[40%] py-8 px-4 z-40'>
            <form className='py-4 space-y-2 w-4xl' onSubmit={handleSubmit}>
              <div className='flex flex-col items-start justify-center '>
                <label
                  htmlFor='name'
                  className=' sm:text-md py-1 text-[#ADA08F] font-[Lato]'
                >
                  {t('guest')}
                </label>
                <input
                  ...
                  name='name'
                  id='name'
                  className='shadow-md focus:ring-[#E3AB8B] focus:border-[#E3AB8B] block w-full sm:text-md border-gray-300 '
                  placeholder={t('name')}
                />
              </div>
              <div className='flex flex-col items-start justify-center'>
      ...
      >
        <div className='w-full flex flex-col justify-between items-center z-40'>
          <p className='text-3xl md:text-4xl font-[Tangerine] font-normal text-center text-[##2B1105] pt-8 '>
            {t('presenza')}
          </p>
        ...
        <footer className='flex flex-col items-center justify-center'>
          <div className='font-[Lato] text-md flex flex-row items-center justify-center flex-nowrap p-2'>
            Made with ❤️ by
            <a href='https://raffaelli.studio/'>Raffaelli.Studio</a>
          </div>
        </footer>
      </section>
    </main>
